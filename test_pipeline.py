...
def run_smoke_tests():
    ...
    matcher = AlgorithmicMatcher("novo_vendor_master.csv", nrows=100000)
    ...
    for i, test in enumerate(test_cases, 1):
        print(
            f"Test {i}: name='{test['name']}'  domain='{test['website']}'  country='{test['country']}'"
        )
